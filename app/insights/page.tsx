...
import { getActivities, getProfile, getGoals } from "../../lib/storage";
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-xs text-gray-600 dark:text-gray-400">
              <div className="space-y-1">
                <p className="font-bold text-gray-800 dark:text-gray-200">🔢 Math first, AI second</p>
                <p className="leading-relaxed">
                  All savings numbers are calculated deterministically from your real data — Gemini only writes the personalized text.
                </p>
              </div>
              <div className="space-y-1">
                <p className="font-bold text-gray-800 dark:text-gray-200">⚡ What-If simulations</p>
                <p className="leading-relaxed">
                  Instant (no API call) — pure math based on your logged activities from the last 7 days.
                </p>
              </div>
              <div className="space-y-1">
                <p className="font-bold text-gray-800 dark:text-gray-200">🔒 Privacy-first</p>
                <p className="leading-relaxed">
